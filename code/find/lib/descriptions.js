module.exports = {
  "Mercurial": {
    ...
    "ko": "구멍투성이의 가장 뜨거운 행선지 머큐리얼 호텔을 소개합니다. 이 곳에 위치한 메나 분화구와 세잔 분화구는 협곡 여행을 하시기에 최적의 풍경을 보여줄 것이며, 이 곳의 기온은 비크람 요가를 하시기에 가장 좋은 환경을 제공해줄 것 입니다." // TODO: translate all descriptions
  },
  "Icarus": {
    ...
    "ko": "태양계의 작은 섬, 이카루스 소행성에 위치한 호텔입니다. 여행 계획을 세우실 땐 저희 사이트에 공지된 궤도 일정표를 꼭 확인해주세요. 태양에 가장 근접하는 주에 선 베딩 스파 이벤트가 준비되어 있습니다."
  },
  "VenusSpaceSpa": {
    ...
    "ko": "밝게 빛나는 별, 금성의 리조트를 소개합니다. 추운 겨울철 휴가는 평균기온 463℃의 따뜻한 금성에서 보내는건 어떨까요? 펄펄 끓는 온천수에 몸을 녹이면 피곤이 눈녹듯 사라질거에요!"
  },
  "HoneyMoon": {
    ...
    "ko": "아름다운 초록별 지구 전망의 토끼네 민박으로 놀러오세요. 부지런한 주인장 토끼아줌마가 매일 아침 계수나무 아래에서 손수 떡방아를 찧어 만든 찹쌀떡을 조식 서비스로 제공합니다."
  },
  "MartianOasis": {
    ...
    "ko": "아늑한 동굴을 찾고 계셨나요? 화성의 남성 전용 호텔, 마션 오아시스 소개합니다. 답답한 일상에서 벗어나 마타라 분화구를 바라보며 여유로운 명상의 시간을 가져보세요."
  },
  "SpaceY": {
  ...
  "SkyResort": {
    ...
    "ko": "토성의 6번째 큰 위성 엔셀라두스에 와보신적 있나요? 이곳은 평균기온 영하 219도 가량으로 깨끗하고 투명한 얼음으로 뒤덮여 있어 더욱 아름답습니다. 호텔 로비를 나서면 바로 헬기 이착륙지가 있어 스키장 슬로프까지 편리하게 이동하실 수 있습니다. 이 곳에서 인생 최고로 짜릿한 스키를 타보세요."
  },
  "BellaTitania": {
    ...
    "ko": "천왕성의 가장 큰 위성 티타니아에 위치한 벨라 호텔은 의료관광지로 삼기 가장 좋은 곳입니다. 저희 호텔에는 태양계 어떤 곳과도 비교할 수 없는 최고의 실력을 자랑하는 성형 외과 의료진과 회복실이 준비되어 있습니다. 럭셔리한 벨라스파에서는 고객 개개인의 취향과 상태에 따라 최적화된 고객 맞춤형 서비스를 제공합니다. 이곳에서 특별한 시간을 보내보세요."
  },
  ...
  "NeptuneSpaceStation": {
    ...
    "ko": "최첨단 기술을 자랑하는 이 리조트에서 아방가르드한 휴가를 보내보세요. 각 방에는 최첨단 기기가 마련되어 있어 가상현실(VR)을 체험할 수 있습니다. 태양계 모든 행성을 배경으로 한 스펙타클한 게임 컨텐츠가 준비되어 있으니 다른 별에 여행 갈 필요가 없으시겠죠?"
  },
  "PlutoWinterLodge": {
    ...
    "ko": "1930년에 오픈한 다크킹 호텔은 우주인들의 꾸준한 사랑을 받다가 지난 2006년 '태양계 퇴출 사건'으로 잠시 문을 닫은 뒤 오랜 리모델링 공사 끝에 2018년 GRAND OPEN을 하였습니다. 태양계 최고의 장거리 여행지 명왕성으로 놀러오세요."
  },
  "CharonsGrotto": {
    "en": "Nothing to see here. It’s just a cold barren rock orbiting Pluto. Definitely nothing shady going on under the surface.",
    "ko": "명왕성의 가장 큰 위성인 카론에 위치한 호텔을 소개합니다. 호텔 주변은 온통 얼음 빙판이니 오실 때 스케이트를 챙겨오세요."
  }
}
